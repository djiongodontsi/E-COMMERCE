...
<head>
    ...
    <link rel="stylesheet" href="Style/Ordinateur_bureau.css">
...
<body>
   ...
   <header>
        <a href="accueil.html">
            <img src="IMG/logo_epsi.png" alt="Logo" />
        </a>
    ...
    <main class="container">
        ...
        <p class="intro-text">Découvrez notre sélection des meilleurs ordinateurs de bureau pour le travail, le jeu et l'art. Trouvez la puissance dont vous avez besoin.</p>
