...
users : Stockage des profils utilisateurs (admin et clients).
article : Gestion du stock, des prix et des images des produits.
commandes : Historique et suivi des achats effectués sur le site.
...
Panier	Articles	Users
⚙️ Installation Locale
Cloner ce dépôt dans votre dossier htdocs.
Démarrer les modules Apache et MySQL via le panneau de contrôle XAMPP.
Importer le fichier .sql (disponible dans le dossier sql/ ou à la racine) dans phpMyAdmin.
Lancer le projet via l'URL : http://localhost/EPSI-Tech/.